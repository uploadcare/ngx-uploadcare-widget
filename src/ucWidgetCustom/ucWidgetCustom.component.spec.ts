...
import { UcWidgetDefaultComponent } from './ucWidgetCustom.component';
describe('Default Widget Component', () => {
  ...
  it('should initialize the component', async(() => {
    const fixture = TestBed.createComponent(UcWidgetDefaultComponent);
